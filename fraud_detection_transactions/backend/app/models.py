...
def load_model():
    ...
    """
    model_path = os.path.join(os.path.dirname(__file__), "data", "fraud_detection_transactions_decision_tree_model.pkl")
...
def load_scaler():
    ...
    Load the scaler.
    """
    scaler_path = os.path.join(os.path.dirname(__file__), "data", "fraud_detection_transactions_scaler.pkl")
...
def load_encoder():
    ...
    Load the encoder.
    """
    encoder_path = os.path.join(os.path.dirname(__file__), "data", "fraud_detection_transactions_encoder.pkl")
